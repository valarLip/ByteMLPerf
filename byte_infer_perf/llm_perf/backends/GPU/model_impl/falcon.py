...
class FalconMLP(nn.Module):
    def __init__(self, config: FalconConfig):
        ...
        self.dense_h_to_4h = FalconLinear(hidden_size, config.ffn_hidden_size // self.mp_size, bias=config.bias)
        self.act = get_activation(config.activation)
        self.dense_4h_to_h = FalconLinear(config.ffn_hidden_size // self.mp_size, hidden_size, bias=config.bias)
        self.hidden_dropout = config.hidden_dropout
